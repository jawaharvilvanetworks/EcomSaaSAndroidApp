...
class PrefHelper {
    ...
    fun setIntToShared(name: String, value: Int) {
        try {
    ...
    fun getIntFromShared(name: String): Int? {
        return try {
    ...
    fun setStringToShared(name: String, value: String) {
        try {
    ...
    fun getStringFromShared(name: String): String? {
        return try {
